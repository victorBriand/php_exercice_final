...
// PAS CHANGE
    ...
    {
        $this->requete = 'UPDATE clients SET nom=:parm1, prenom=:parm2, adresse=:parm3, code_postal=:parm4, ville=:parm5, commentaire=:parm6 WHERE id=:parm0';
...
*/
        ...
        $this->requete = 'DELETE FROM clients WHERE id=:parm0';
        $this->requete = $this->connection->prepare($this->requete);
        $this->requete->bindParam(':parm0', $parmForm['parm0']);
        $this->executeTryCatch();
    }
