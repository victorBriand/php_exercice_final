...
*/
        ...
        $this->page .= "<h1>Je suis sur la liste 3</h1>";
        ...
        ."<td>$ligne[5]</td>"
        ."<td>$ligne[6]</td>"
        ."<td><a href='index.php?controller=prospects&action=update&parm0=$ligne[0]&parm1=$ligne[1]&parm2=$ligne[2]&parm3=$ligne[3]&parm4=$ligne[4]&parm5=$ligne[5]&parm6=$ligne[6]'><i class='fas fa-pencil-alt text-success'></i></a></td>"
        ."<td><a href='index.php?controller=prospects&action=delete&parm0=$ligne[0]&parm1=$ligne[1]&parm2=$ligne[2]&parm3=$ligne[3]&parm4=$ligne[4]&parm5=$ligne[5]&parm6=$ligne[6]'><i class='fas fa-trash-alt text-danger'></i></a></td></tr>";
        }
        $tableau .= "</tbody></table><div class='form-group'>
        <a href='index.php?controller=prospects&action=add'>Ajouter un élément</a>
        </div></div>";
        $this->page .= $tableau;
        $this->display();
    }
