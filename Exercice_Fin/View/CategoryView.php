...
*/
        ...
        ."<td>$ligne[2]</td>"
        ."<td><a href='index.php?controller=category&action=update&parm0=$ligne[0]&parm1=$ligne[1]&parm2=$ligne[2]'><i class='fas fa-pencil-alt text-success'></i></a></td>"
        ."<td><a href='index.php?controller=category&action=delete&parm0=$ligne[0]&parm1=$ligne[1]&parm2=$ligne[2]'><i class='fas fa-trash-alt text-danger'></i></a></td></tr>";
        }
        $tableau .= "</tbody></table><div class='form-group'>
        <a href='index.php?controller=category&action=add'>Ajouter un élément</a>
        </div></div>";
        $this->page .= $tableau;
        $this->display();
    }
